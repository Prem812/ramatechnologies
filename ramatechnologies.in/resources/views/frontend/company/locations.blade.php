						...
						<div class="main-content-inner">
							<div class="content">
								<div style="" data-vc-stretch-content="true"
									class="vc_row wpb_row vc_row-fluid vc_custom_1644801667719 vc_row-has-fill vc_row-no-padding">
									<div class="row-inner">
								...
								<section style="" class="vc_section fix-overflow vc_custom_1575621428181">
									<div style="" class="vc_row wpb_row vc_row-fluid">
										<div class="row-inner">
											...
											<div class="wpb_column vc_column_container vc_col-sm-8">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<h2 style="text-align: center" class="vc_custom_heading">Located
															Around the World</h2>
														<div style="text-align: center" class="vc_custom_heading">With
															3+ regions across the globe, we can get your database or
															messaging service there.</div>
															...
															<div class="wpb_wrapper">
																<div class="wrap_svl_center">
																	<div class="wrap_svl_center_box">
																		<div class="wrap_svl" id="body_drag_104">
									...
									<div style="" class="vc_row wpb_row vc_row-fluid vc_custom_1575621435738">
										<div class="row-inner">
											<div
													...
													<div class="wpb_wrapper">
														<div class="iconbox  ">
															...
															<div class="box-detail">
																<p>2307 Beverley Rd Brooklyn, New York 11226 United
																	States.</p>
															...
															<div class="box-icon"><img decoding="async"
																	src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"
																	alt="United States"
																	data-lazy-src="{{url('frontend/rt-content/uploads/2018/08/001-united-states.svg')}}" /><noscript><img
																		decoding="async"
																		src="{{url('frontend/rt-content/uploads/2018/08/001-united-states.svg')}}"
																		alt="United States" /></noscript></div>
												...
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="iconbox  ">
															...
															<div class="box-detail">
																<p>Address: Schulstr. 9 70173 Stuttgart Germany. Phone:
																	+49 711 17 22244</p>
															...
															<div class="box-icon"><img decoding="async"
																	src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"
																	alt="Germany"
																	data-lazy-src="{{url('frontend/rt-content/uploads/2018/08/002-germany.svg')}}" /><noscript><img
																		decoding="async"
																		src="{{url('frontend/rt-content/uploads/2018/08/002-germany.svg')}}"
																		alt="Germany" /></noscript></div>
												...
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="iconbox  ">
															...
															<div class="box-detail">
																<p>Address: 4 Zemlyanoy val, bld.1 Moscow, Russia 105064
																</p>
															...
															<div class="box-icon"><img decoding="async"
																	src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"
																	alt="Russia"
																	data-lazy-src="{{url('frontend/rt-content/uploads/2018/08/003-russia.svg')}}" /><noscript><img
																		decoding="async"
																		src="{{url('frontend/rt-content/uploads/2018/08/003-russia.svg')}}"
																		alt="Russia" /></noscript></div>
