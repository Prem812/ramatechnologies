	...
	<div id="off-canvas-right" class="off-canvas sliding-menu">
		...
		<div class="off-canvas-wrap">
			...
			<ul id="menu-mobile" class="menu menu-sliding">
				...
				<li id="menu-item-280"
					class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-280">
					<a href="../it-blog/index.html" data-ps2id-api="true">IT Blog</a>
					<ul class="sub-menu">
						<li id="menu-item-798"
						...
						<li id="menu-item-801"
							class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-493 current_page_item menu-item-801">
							<a href="index.html" aria-current="page" data-ps2id-api="true">Medium Image (with
								sidebar)</a></li>
						<li id="menu-item-799"
	...
	<script data-no-minify="1" async src="{{url('frontend/rt-content/plugins/wp-rocket/assets/js/lazyload/17.5/lazyload.min.js')}}"></script>
</body>
