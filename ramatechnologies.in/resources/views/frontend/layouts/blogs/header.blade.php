...
<head>
	...
	<link rel="stylesheet" href="{{url('frontend/rt-content/cache/min/1/48e9a6e4d5e25bd76c7adc799f87b638.css')}}" media="all"
		data-minify="1" />
	...
	<style id='nanosoft-inline-css' type='text/css'>
		...
		.content-header {
			background-color: #ffffff;
			background-image: url({{url('frontend/rt-content/uploads/2018/05/john-schnobrich-520023-unsplash1.jpg')}});
			margin-top: 0px;
			margin-right: 0px;
			margin-bottom: 60px;
			margin-left: 0px;
...
<body
	class="page-template page-template-tmpl page-template-template-blog-medium page-template-tmpltemplate-blog-medium-php page page-id-493 sliding-desktop-off sliding-overlay layout-wide sidebar-right wpb-js-composer js-comp-ver-6.8.0 vc_responsive blog-medium"
				...
				<div class="header-content">
					...
					<nav class="navigator" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
						...
						<ul id="menu-main-menu" class="menu menu-primary">
							...
							<li id="menu-item-458"
								class="click menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-458">
								...
								<ul class="sub-menu">
									...
									<li id="menu-item-501"
										class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-493 current_page_item menu-item-501">
										<a href="index.html" aria-current="page" data-ps2id-api="true">Medium Image
											<sup>with sidebar</sup></a></li>
									<li id="menu-item-503"
