    ...
    const i = (e, t) => {
            for (const r in t) {
                ...
                e.querySelectorAll(`input[name="${r}"]`).forEach((e) => {
                    ...
                    e
                        .querySelectorAll(`img.wpcf7-captcha-${r}`)
                        .forEach((e) => {
                ...
                a &&
                    e
                        .querySelectorAll(
                            `input[name="_wpcf7_captcha_challenge_${r}"]`
                        )
                        .forEach((e) => {
                            e.value = a[1];
                        });
        ...
        l = (e, t) => {
            for (const r in t) {
                const n = t[r][0],
                    a = t[r][1];
                e.querySelectorAll(`.wpcf7-form-control-wrap.${r}`).forEach(
                    (e) => {
                        (e.querySelector(`input[name="${r}"]`).value = ""),
                            (e.querySelector(".wpcf7-quiz-label").textContent =
                                n),
                            (e.querySelector(
                                `input[name="_wpcf7_quiz_answer_${r}"]`
                            ).value = a);
                    }
                );
            }
        ...
        (t.wpcf7 = {
            ...
            t.addEventListener("wpcf7submit", (e) => {
                e.detail.apiResponse.captcha &&
                    i(t, e.detail.apiResponse.captcha),
