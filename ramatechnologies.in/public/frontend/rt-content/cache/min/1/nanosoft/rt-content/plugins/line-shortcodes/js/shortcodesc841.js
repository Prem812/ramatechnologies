...
(function ($) {
    ...
    var doc = $(document),
        win = $(window);
    $(function () {
        win.smartresize(Waypoint.refreshAll).on("load", Waypoint.refreshAll);
        if ($.fn.countTo) {
        ...
        if ($.fn.countdown) {
            $(".countdown").each(function () {
                var format = [],
                    ...
                    config = {
                        year:
                            '<span class="years"><span class="number">%-Y</span> %!Y:' +
                            _countdownLocalize.year +
                            "," +
                            _countdownLocalize.year +
                            "s;</span>",
                        month:
                            '<span class="months"><span class="number">%-m</span> %!m:' +
                            _countdownLocalize.month +
                            "," +
                            _countdownLocalize.month +
                            "s;</span>",
                        week:
                            '<span class="weeks"><span class="number">%-w</span> %!w:' +
                            _countdownLocalize.week +
                            "," +
                            _countdownLocalize.week +
                            "s;</span>",
                        day:
                            '<span class="days"><span class="number">%-d</span> %!d:' +
                            _countdownLocalize.day +
                            "," +
                            _countdownLocalize.day +
                            "s;</span>",
                        hour:
                            '<span class="hours"><span class="number">%-H</span> %!H:' +
                            _countdownLocalize.hour +
                            "," +
                            _countdownLocalize.hour +
                            "s;</span>",
                        minute:
                            '<span class="minutes"><span class="number">%-M</span> %!M:' +
                            _countdownLocalize.minute +
                            "," +
                            _countdownLocalize.minute +
                            "s;</span>",
                        second:
                            '<span class="seconds"><span class="number">%-S</span> %!S:' +
                            _countdownLocalize.second +
                            "," +
                            _countdownLocalize.second +
                            "s;</span>",
                    };
                ...
                $.map(config, function (value, key) {
                    if (parts.indexOf(key) == -1) format.push(value);
                });
