(function ($) {
    ...
    (function ($) {
        ...
        CanvasEffect.prototype = {
            ...
            _animate: function () {
                ...
                for (var i in this.points) {
                    if (
                        Math.abs(getDistance(this.target, this.points[i])) <
                        4000
                    ) {
    ...
    $.mobileMenu = function () {
        $(
            "ul.menu li.menu-item-has-children, ul.menu li.page_item_has_children"
        ).each(function () {
            var menuItem = $(this);
            var menuToggle = $(
        ...
        return this.each(function () {
            ...
            if (thumbs.size() > 0) {
                ...
                thumbs.on("click", ".swiper-slide", function () {
                    ...
                    thumbs
                        .find(".swiper-slide:nth(" + slideIndex + ")")
        ...
        return this.each(function () {
            ...
            try {
                ...
                if (invalidLocations.length > 0) {
                    $.when
                        .apply($, queryAddressLocations(locations))
                        .done(function () {
    ...
    $(function () {
        ...
        $(".content-header .down-arrow a").on("click", function () {
            ...
            var contentOffset =
                $(".content-header").offset().top +
                $(".content-header").outerHeight();
            $("html, body").animate({
                scrollTop:
                    contentOffset - (stickyHeaderHeight + adminbarHeight),
            });
        });
